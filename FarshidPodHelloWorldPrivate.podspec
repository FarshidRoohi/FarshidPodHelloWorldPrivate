Pod::Spec.new do |spec|
  ...
  spec.source        = { :http => "https://github.com/FarshidRoohi/FarshidPodHelloWorldPrivate/releases/download/0.0.3/PrivateTest.zip" }
  spec.source_files  = "PrivateTest/**/*.{h,m,swift}"
